  ...
  <header class="navbar">
    <div class="profile">
      <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width="48" height="48" class="profile-avatar">
        <circle cx="24" cy="24" r="24" fill="#1a1e2e"></circle>
        <circle cx="24" cy="19" r="8" fill="#4f8ef7"></circle>
        <ellipse cx="24" cy="40" rx="13" ry="9" fill="#4f8ef7"></ellipse>
    ...
    <section class="roadmap">
      ...
      <div class="roadmap-item completed">
        <div class="item-icon">
          ...
          <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" width="36" height="36">
            <rect width="100" height="100" rx="12" fill="#C71A36"></rect>
      ...
      <div class="roadmap-item completed">
        <div class="item-icon">
          <!-- Jenkins SVG -->
          <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" width="36" height="36">
            <ellipse cx="50" cy="42" rx="32" ry="36" fill="#D33833"></ellipse>
            <ellipse cx="50" cy="40" rx="28" ry="32" fill="#F0D6B7"></ellipse>
            <circle cx="42" cy="36" r="4" fill="#2C2C2C"></circle>
            <circle cx="58" cy="36" r="4" fill="#2C2C2C"></circle>
            <path d="M38 52 Q50 62 62 52" stroke="#2C2C2C" stroke-width="2.5" fill="none" stroke-linecap="round"></path>
            <path d="M30 20 Q50 5 70 20" stroke="#2C2C2C" stroke-width="3" fill="none"></path>
            <rect x="44" y="70" width="12" height="18" rx="3" fill="#D33833"></rect>
            <ellipse cx="50" cy="90" rx="14" ry="5" fill="#B02020"></ellipse>
          </svg>
        </div>
        <div class="item-body">
          <div class="item-top">
      ...
      <div class="roadmap-item pending">
        <div class="item-icon">
          <!-- Ansible SVG -->
          <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" width="36" height="36">
            <circle cx="50" cy="50" r="48" fill="#1A1918"></circle>
            <path d="M50 10 A40 40 0 1 1 49.999 10Z" fill="#1A1918"></path>
            <circle cx="50" cy="50" r="48" fill="none" stroke="#EE0000" stroke-width="3"></circle>
            <path d="M35 75 L55 25 L75 75 L60 55 Z" fill="white"></path>
          </svg>
        </div>
        <div class="item-body">
          <div class="item-top">
      ...
      <div class="roadmap-item pending">
        <div class="item-icon">
          ...
          <svg viewBox="0 0 100 70" xmlns="http://www.w3.org/2000/svg" width="40" height="28">
            <!-- Containers grid -->
            <rect x="4" y="28" width="16" height="14" rx="2" fill="#2496ED"></rect>
            <rect x="22" y="28" width="16" height="14" rx="2" fill="#2496ED"></rect>
            <rect x="40" y="28" width="16" height="14" rx="2" fill="#2496ED"></rect>
            <rect x="22" y="12" width="16" height="14" rx="2" fill="#2496ED"></rect>
            <rect x="40" y="12" width="16" height="14" rx="2" fill="#2496ED"></rect>
            <rect x="40" y="0" width="16" height="10" rx="2" fill="#2496ED"></rect>
            <!-- Whale body -->
            <path d="M8 46 Q50 58 90 46 Q95 55 85 62 Q50 70 15 62 Q5 55 8 46Z" fill="#2496ED"></path>
            <!-- Water spray -->
            <path d="M78 36 Q82 28 80 22" stroke="#2496ED" stroke-width="2.5" fill="none" stroke-linecap="round"></path>
            <path d="M80 22 Q84 18 82 14" stroke="#2496ED" stroke-width="2" fill="none" stroke-linecap="round"></path>
          </svg>
        </div>
        <div class="item-body">
          <div class="item-top">
      ...
      <div class="roadmap-item pending">
        <div class="item-icon">
          <!-- Kubernetes SVG -->
          <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" width="36" height="36">
            <circle cx="50" cy="50" r="48" fill="#326CE5"></circle>
            <!-- Helm wheel spokes -->
            <line x1="50" y1="10" x2="50" y2="90" stroke="white" stroke-width="4" stroke-linecap="round"></line>
            <line x1="10" y1="50" x2="90" y2="50" stroke="white" stroke-width="4" stroke-linecap="round"></line>
            <line x1="21" y1="21" x2="79" y2="79" stroke="white" stroke-width="4" stroke-linecap="round"></line>
            <line x1="79" y1="21" x2="21" y2="79" stroke="white" stroke-width="4" stroke-linecap="round"></line>
            <!-- Outer ring -->
            <circle cx="50" cy="50" r="40" fill="none" stroke="white" stroke-width="5"></circle>
            <!-- Center hub -->
            <circle cx="50" cy="50" r="12" fill="white"></circle>
            <circle cx="50" cy="50" r="7" fill="#326CE5"></circle>
          </svg>
        </div>
        <div class="item-body">
          <div class="item-top">
      ...
      <div class="roadmap-item pending">
        <div class="item-icon">
          ...
          <svg viewBox="0 0 100 115" xmlns="http://www.w3.org/2000/svg" width="32" height="37">
            <polygon points="38,0 38,40 72,20" fill="#7B42BC"></polygon>
            <polygon points="0,22 0,62 34,42" fill="#7B42BC"></polygon>
            <polygon points="40,22 40,62 74,42" fill="#5C4EE5"></polygon>
            <polygon points="40,68 40,108 74,88" fill="#7B42BC"></polygon>
          </svg>
        </div>
        <div class="item-body">
          <div class="item-top">
